...
export const ArchitectureVisualizer = () => {
  ...
  return (
    <section id="architecture" className="py-24 relative overflow-hidden bg-[var(--bg-main)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-14">
            ...
            {methodologyPillars.map((item, idx) => {
              ...
              return (
                <button
                  ...
                  className={`text-left p-5 rounded-2xl transition-all relative group border cursor-pointer ${
                    isSelected 
                      ? `bg-[#0e1424] ${accent.activeBorder} scale-[1.02] shadow-xl` 
                      : 'bg-[#0e1424]/60 border-white/5 hover:border-cyan-500/50 shadow-sm'
                  }`}
                >
                  {/* Step indicator */}
                  <div className="flex items-center justify-between mb-4">
                    <span className={`text-2xl font-black font-mono ${isSelected ? accent.numColor : 'text-slate-600'}`}>
                      {item.phase}
                    </span>
                    <div className={`p-2.5 rounded-xl ${isSelected ? accent.iconBg : 'bg-white/5 text-slate-400'}`}>
                      <IconComp size={18} />
                    </div>
                  </div>

                  <h3 className="text-base font-extrabold text-white mb-2 leading-snug group-hover:text-cyan-300 transition-colors">
                    {item.title}
                  </h3>
          ...
          <div className="bg-[#0e1424] p-6 sm:p-9 rounded-3xl border border-white/10 relative overflow-hidden shadow-lg">
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-white/10 pb-4 mb-6">
              <div className={`inline-flex items-center gap-2 text-xs font-mono px-3.5 py-1.5 rounded-lg border font-bold ${phaseAccents[activePhase].badge}`}>
            ...
            <div className="max-w-4xl space-y-6">
              ...
              {/* Deliverables */}
              <div className="pt-2">
                <div className="text-xs font-mono uppercase tracking-wider text-slate-300 mb-3.5 flex items-center gap-2 font-bold">
                ...
                <div className="flex flex-wrap gap-3">
                  {methodologyPillars[activePhase].deliverables.map((deliv, i) => (
                    <span 
                      key={i}
                      className="px-4 py-2 rounded-xl bg-white/5 border border-cyan-500/20 text-xs font-mono font-bold text-cyan-200 flex items-center gap-2 hover:border-cyan-500 transition-colors shadow-sm"
                    >
        ...
        {/* ======================================================== */}
        <div className="bg-[#0a0f1c] p-6 sm:p-10 rounded-3xl border border-cyan-500/30 relative overflow-hidden shadow-2xl">
          
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 border-b border-white/10 pb-4 mb-8">
            <div>
              <div className="text-xs font-mono text-cyan-400 uppercase tracking-wider flex items-center gap-2 mb-1 font-bold">
                <GitMerge size={16} />
            ...
            <span className="text-xs font-mono font-bold text-slate-200 px-3.5 py-1.5 rounded-lg bg-white/5 border border-white/10 self-start md:self-auto shadow-sm">
              CORE OPERATIONAL HUB • CONSTANT ACROSS ALL PHASES
            </span>
          </div>

          <p className="text-xs sm:text-sm text-slate-300 leading-relaxed max-w-3xl mb-8 font-normal">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative">
            ...
            <div className="p-6 rounded-2xl bg-[#0c1220] border border-blue-500/30 flex flex-col justify-between group hover:border-blue-400 transition-colors shadow-sm">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="p-3 rounded-xl bg-blue-500/15 text-blue-400">
                    <Users size={20} />
                  </span>
              ...
              <div className="mt-5 pt-3 border-t border-white/10 font-mono text-[11px] text-slate-400 flex items-center gap-2 font-bold">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-b from-cyan-950/60 via-[#0c1427] to-purple-950/60 border-2 border-cyan-400 shadow-[0_0_30px_rgba(0,242,254,0.18)] flex flex-col justify-between relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-[10px] font-mono font-black text-white tracking-widest uppercase shadow-md">
                CENTRAL ARCHITECTURAL HUB
              </div>

              <div>
                <div className="flex items-center justify-between mb-4 mt-1">
                  <span className="p-3 rounded-xl bg-cyan-500/20 text-cyan-300">
                    <Cpu size={20} />
                  </span>
              ...
              <div className="mt-5 pt-3 border-t border-cyan-500/30 font-mono text-[11px] text-cyan-300 flex items-center gap-2 font-bold">
            ...
            <div className="p-6 rounded-2xl bg-[#0c1220] border border-emerald-500/30 flex flex-col justify-between group hover:border-emerald-400 transition-colors shadow-sm">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="p-3 rounded-xl bg-emerald-500/15 text-emerald-400">
